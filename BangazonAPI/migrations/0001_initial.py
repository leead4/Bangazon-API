# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-04-27 18:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BangazonAPI.Department')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BangazonAPI.Employee')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.AddField(
            ...
            name='training',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BangazonAPI.TrainingCourse'),
        ),
        migrations.AddField(
            model_name='computer',
            name='employee',
